...
// AppsV1alpha1Client is used to interact with features provided by the apps.clientgo-learning.io group.
type AppsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppsV1alpha1Client) Websites() WebsiteInterface {
	return newWebsites(c)
}
